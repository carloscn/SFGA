...
public:
    ...
    void retranslateUi(QWidget *SafeGuard)
    {
        ...
        pushButton_warning->setText(QApplication::translate("SafeGuard", "\346\212\245\350\255\246\350\255\246\345\221\212", Q_NULLPTR));
